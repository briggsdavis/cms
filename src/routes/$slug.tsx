...
function ProjectPage() {
  ...
  const { data: project } = useSuspenseQuery(convexQuery(api.projects.getBySlug, { slug }))
  ...
  if (!project) return <main className="max-w-xl mx-auto p-8">Project not found</main>
